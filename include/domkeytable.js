...
//addStandard("AllCandidates", XK_MultipleCandidate);
//addStandard("Alphanumeric", XK_Eisu_Shift); // could also be _Eisu_Toggle
//addStandard("CodeInput", XK_Codeinput);
//addStandard("Compose", XK_Multi_key);
//addStandard("Convert", XK_Henkan);
// - Dead
// - FinalMode
//addStandard("GroupFirst", XK_ISO_First_Group);
//addStandard("GroupLast", XK_ISO_Last_Group);
//addStandard("GroupNext", XK_ISO_Next_Group);
//addStandard("GroupPrevious", XK_ISO_Prev_Group);
// - ModeChange (XK_Mode_switch is often used for AltGr)
// - NextCandidate
//addStandard("NonConvert", XK_Muhenkan);
//addStandard("PreviousCandidate", XK_PreviousCandidate);
// - Process
//addStandard("SingleCandidate", XK_SingleCandidate);
//addStandard("HangulMode", XK_Hangul);
//addStandard("HanjaMode", XK_Hangul_Hanja);
//addStandard("JunjuaMode", XK_Hangul_Jeonja);
//addStandard("Eisu", XK_Eisu_toggle);
//addStandard("Hankaku", XK_Hankaku);
//addStandard("Hiragana", XK_Hiragana);
//addStandard("HiraganaKatakana", XK_Hiragana_Katakana);
//addStandard("KanaMode", XK_Kana_Shift); // could also be _Kana_Lock
//addStandard("KanjiMode", XK_Kanji);
//addStandard("Katakana", XK_Katakana);
//addStandard("Romaji", XK_Romaji);
//addStandard("Zenkaku", XK_Zenkaku);
//addStandard("ZenkakuHanaku", XK_Zenkaku_Hankaku);
